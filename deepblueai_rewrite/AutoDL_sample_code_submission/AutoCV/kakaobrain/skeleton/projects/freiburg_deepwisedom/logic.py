...
class LogicModel(Model):
    def __init__(self, metadata, session=None):
        ...
        # deepwisdom dataloading parameter
        self.hyper_params["conditions"]["early_epoch"] = 1
        self.hyper_params["dataset"]["steps_per_epoch"] = 30
        self.hyper_params["dataset"]["max_valid_count"] = 256
        self.hyper_params["dataset"]["batch_size_test"] = 64
    ...
    def train(self, dataset, remaining_time_budget=None):
        ...
        # if self.done_training and \
                # (not self.changed_model) and\
                # remaining_time_budget > 600:
    ...
    def test(self, dataset, remaining_time_budget=None):
        ...
        # if self.save_res: # 清空保存的模型，更换模型
            # self.checkpoints = []
            # self.change_model()
            # self.save_res = False
            # self.changed_model = True
            # LOGGER.info('[change_model]')
