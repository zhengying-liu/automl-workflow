...
# actually only one path below is correct (add both to make sure functionality)
sys.path.insert(0, os.path.abspath("run/submission/AutoFolio"))
sys.path.insert(0, os.path.abspath("submission/AutoFolio"))
