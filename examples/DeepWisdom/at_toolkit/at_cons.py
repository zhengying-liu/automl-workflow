...
SPEECH_TR34_DW_PT_MODEL_DIR = os.path.join(ADL_ROOT_PATH, "at_speech", "deepwisdom_model", "pretrained_models")
SPEECH_TR34_DW_PT_MODEL_PATH = os.path.join(SPEECH_TR34_PT_MODEL_DIR, TR34_FN)
