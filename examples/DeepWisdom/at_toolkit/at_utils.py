...
from at_toolkit.at_cons import SPEECH_TR34_PT_MODEL_PATH, SPEECH_TR34_PT_MODEL_DIR, SPEECH_TR34_DW_PT_MODEL_DIR, SPEECH_TR34_DW_PT_MODEL_PATH
...
def autodl_speech_install_download():
    ...
    print("speech tr34 model_dir={}, model_path={}".format(SPEECH_TR34_PT_MODEL_DIR, SPEECH_TR34_PT_MODEL_PATH))
    down_tr34_cmd = "wget -P {} http://120.27.216.109:8011/thin_resnet34.h5".format(SPEECH_TR34_PT_MODEL_DIR)
    if not os.path.isfile(SPEECH_TR34_PT_MODEL_PATH):
        print("no exists, down_tr34_cmd = {}".format(down_tr34_cmd))
        os.system(down_tr34_cmd)

    # model for deepwisdom.
    print("speech dw_tr34 model_dir={}, model_path={}".format(SPEECH_TR34_DW_PT_MODEL_DIR, SPEECH_TR34_DW_PT_MODEL_PATH))
    down_tr34_cmd = "wget -P {} http://120.27.216.109:8011/thin_resnet34.h5".format(SPEECH_TR34_DW_PT_MODEL_DIR)
    if not os.path.isfile(SPEECH_TR34_DW_PT_MODEL_PATH):
        print("no exists, down_tr34_cmd = {}".format(down_tr34_cmd))
        os.system(down_tr34_cmd)

    os.system('pip3 install kapre==0.1.4 -i https://pypi.tuna.tsinghua.edu.cn/simple')
    print("install kapre=0.1.4 finished.")
...
# TODO: need run in model.init method.
...
# autodl_install_download()

def tfdataset_warmup():
