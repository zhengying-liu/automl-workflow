...
#   put them under the folder public_data/. This script supports
...
def main(*argv):
    ...
    for dataset_name in dataset_names:
        ...
        os.system("wget -q --show-progress -c -N {} -O {}".format(data_url, data_zip_file))
        os.system("wget -q --show-progress -c -N {} -O {}".format(solution_url, solution_zip_file))
        os.system("unzip -n -d {} {}".format(dataset_dir, data_zip_file))
        os.system("unzip -n -d {} {}".format(dataset_dir, solution_zip_file))
    print("\nFinished downloading {} public datasets: {}".format(len(dataset_names), dataset_names))
    print("Now you should find them under the directory: {}".format(public_date_dir))
