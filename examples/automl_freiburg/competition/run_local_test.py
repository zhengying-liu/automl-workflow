...
from competition.ingestion_program.ingestion import ingestion_fn
from competition.scoring_program.score import score_fn
...
if __name__ == "__main__":
    ...
    parser.add_argument("--code_dir", default=".", help=" ")
